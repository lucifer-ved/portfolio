...
export const WorkData = [
    {
        ...
        companyDetails:{
            ...
            thingsWorkedOn:'<p>1. <b>Designed and built a module used by hedge fund analysts</b> to understand the forecast and historical data of companies across different sectors and industries.<br/><br/>2. <b>Developed an automated service</b> that runs at a particular time, fetched files from the SFTP server , parse the files, and feeds required data to the database. <b>Earlier, this entire process used to be done manually.</b><br/><br/>3. <b>Co-Developed in-house web analytics tool</b> to keep track of user activities like how many features they are using, how many features they are interacting with, how much time they are spending on each feature etc.<br/><br/>4. <b>Laid out a foundation to migrate</b> the entire backend application from <b>MySQL 5.6 to MySQL 8.0</b><br/><br/>5. <b>Contributed to sharding activity</b> which improved the <b>data fetching performance by 20%</b><br/><br/>6. <b>Contributed in migrating</b> the entire frontend application from <b>Angular 2 to Angular 8.</b></p>'
            ,
            challenges:"<p>1. <b>Comping up with a solution</b> to fetch data of multiple companies effectively <b>to minimize the grid load time of the module.</b><br/><br/>2. Figuring out a way to <b>update all queries from MySQL 5.7 to MYSQL 8.0</b> in such a way that it requires <b>minimum code change and an effective rollback plan</b> in case if anything goes wrong in production.<br><br/>3.<b>Understanding Frontend Codebase</b>and helping in-migration from <b>Angular 2 to Angular 8.</b></p>"
        },
        to:'/va',
        showChallenges:true
    ...
    },
    {
        ...
        companyDetails:{
            ...
            thingsWorkedOn:'<p>Contributed in developing on of the module for pricing management solution </p>'
